...
[Скачать версию 2021.02.02](https://github.com/alekssamos/textnormalizer_for_nvda/releases/latest/download/textnormalizer_for_nvda-2021.02.02.nvda-addon)
...
* Показать диалог настроек - Включить копирование в буфер обмена, а так же протестировать конвертер, два текстовых поля, в одно пишете, нажимаете на кнопку, во втором получаете исправленный текст;
...
* ПPEДЛ@Г@Ю 3@paб0т0к В ИнтepHeте бeз BЛOЖEHИй!
